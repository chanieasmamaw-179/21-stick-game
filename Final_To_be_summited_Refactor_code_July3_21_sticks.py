...
def bot_move(sticks):
	...
	"""
	if sticks % 4 == 1:
		return 1  # Take 1 stick to leave a multiple of 4 sticks
	elif sticks % 4 == 2:
		return 2  # Take 2 sticks to leave a multiple of 4 sticks
	elif sticks % 4 == 3:
		return 3  # Take 3 sticks to leave a multiple of 4 sticks
	else:
		return 1  # Default case (sticks % 4 == 0), take 1 stick to maintain strategy
